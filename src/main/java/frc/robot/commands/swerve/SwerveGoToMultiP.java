...
public class SwerveGoToMultiP extends CommandBase {
  ...
  // Command constructor
  public SwerveGoToMultiP(SwerveSubsystem swerveSubsystem,Supplier<Double> headingFunction,
  //double xSetpoint, double ySetpoint, double tSetpoint, boolean reset, Pose2d resetPose){
  List<SetPoint> setpoints, double tolerance, double pValue){
    ...
    vXController = new PIDController(pValue, 0.006, 0.008);
    vYController = new PIDController(pValue, 0.006, 0.008);
