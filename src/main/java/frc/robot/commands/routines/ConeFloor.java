...
public class ConeFloor extends SequentialCommandGroup{
    
    public ConeFloor(ElevatorSubsystem elevatorSubsystem, GrabberSubsystem grabberSubsystem){
        ...
        new ElevatorMeters(elevatorSubsystem, 1.0)
        );
    }
}