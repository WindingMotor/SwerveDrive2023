...
public class BalanceOver extends SequentialCommandGroup{

    // Routine command constructor
    public BalanceOver(SwerveSubsystem swerveSubsystem, ElevatorSubsystem elevatorSubsystem, GrabberSubsystem grabberSubsystem, PIDController xController,
    PIDController yController,  PIDController ppthetaController, Leds leds){
        ...
        new SwerveGoToP(swerveSubsystem, () -> swerveSubsystem.getHeading(),0, 6.0, 0.0, true, new Pose2d(), 0.14, 2.0, 0.25),
        new WaitCommand(0.8),
        new SwerveGoToP(swerveSubsystem, () -> swerveSubsystem.getHeading(),0, 1, 0.0, false, null,0.2, 5, 0.5),
        new WaitCommand(1),
